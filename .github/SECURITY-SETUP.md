...
This document describes the secrets and configuration required for the German Law Law MCP GitHub Actions workflows.

## Required Secrets

| Secret | Used By | Description |
|--------|---------|-------------|
| `NPM_TOKEN` | `publish.yml` | npm automation token for publishing `@ansvar/german-law-mcp` |
...
3. Select **Granular Access Token** with:
   - **Packages and scopes**: Read and write, scoped to `@ansvar/german-law-mcp`
